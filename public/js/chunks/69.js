    ...
    return {
      ...
      knowledgePanel: {
        ...
        suggestedSearches: [{
          ...
          url: 'https://themeforest.net/item/apex-angular-4-bootstrap-admin-template/20774875'
        }, {
          name: 'Convex',
          img: __webpack_require__(/*! @assets/images/pages/3-convex.png */ "./resources/assets/images/pages/3-convex.png"),
          url: 'https://themeforest.net/item/convex-angular-bootstrap-admin-dashboard-template/22424619'
        }, {
          name: 'Materialize',
          img: __webpack_require__(/*! @assets/images/pages/4-materialize.png */ "./resources/assets/images/pages/4-materialize.png"),
          url: 'https://themeforest.net/item/materialize-material-design-admin-template/11446068'
        }, {
          name: 'Stack',
          img: __webpack_require__(/*! @assets/images/pages/2-stack.png */ "./resources/assets/images/pages/2-stack.png"),
          url: 'https://themeforest.net/item/stack-responsive-bootstrap-4-admin-template/20039431'
        }]
      },
      searchResults: [{
        title: 'Modern Admin - Clean Bootstrap 4 Dashboard HTML Template',
        ...
        resultUrl: 'https://1.envato.market/vuexy_admin',
        metaData: {
          ratings: 5,
